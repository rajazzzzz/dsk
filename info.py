...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://filmadda:AhqzPphdF6e7AwEK@cluster0.bggihn4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DATABASE_NAME = environ.get('DATABASE_NAME', "filmadda")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+hhykaaJqZwBmZmE1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+Y9NcU3DhpvY0YTc1')
...
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', '-1002558927719'))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002558927719')).split()]
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002558927719'))
